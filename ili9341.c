...
void ILI9341_WriteData(uint8_t const *buff, size_t buff_size)
{
	ILI9341_RegData();
	spi_set_format(ili9341_spi, 8, SPI_CPOL_1, SPI_CPOL_1, SPI_MSB_FIRST);
...
void ILI9341_SendCommand(uint8_t commandByte, uint8_t const *dataBytes,
